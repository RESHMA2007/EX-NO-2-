...
int main() {
    ...
    char plaintext[] = "subramaniprasadpriyankaz";
    char digraphs[50][2];
...
<img width="679" height="518" alt="Screenshot 2026-01-24 093456" src="https://github.com/user-attachments/assets/d6ab1909-8605-4e18-b681-f251c22f2569" />

## Result:
Thus the program to execute Playfair Cipher has been executed successfully.
